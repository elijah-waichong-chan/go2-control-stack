...
def generate_launch_description():
    ...
    enable_up_down_estimator = LaunchConfiguration("enable_up_down_estimator")
    go2_odom_launch = (
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            "enable_up_down_estimator",
            default_value="false",
            description="Launch up_down_intent_estimator node",
        ),
        ...
        Node(
            ...
            name='up_down_intent_estimator',
            output='screen',
            condition=IfCondition(enable_up_down_estimator),
        ),
        Node(
